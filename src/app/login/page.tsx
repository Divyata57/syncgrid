...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050506] px-4 relative overflow-hidden">
      {/* Background glow accents */}
      <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-rose-950/10 blur-[120px] animate-red-pulse pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-red-950/10 blur-[120px] animate-red-pulse pointer-events-none" />
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel rounded-2xl p-8 border border-zinc-900 relative overflow-hidden shadow-2xl">
          ...
          <div className="mt-8 text-center text-sm text-zinc-500">
            ...
            <Link href="/register" className="text-red-500 hover:text-red-400 hover:underline font-medium">
              Create one
            </Link>
          </div>
        </div>
